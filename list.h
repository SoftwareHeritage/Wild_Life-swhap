...
typedef void *			Ref;
typedef struct _ListLinks *	RefListLinks;
typedef struct _ListHeader *	RefListHeader;
...
extern int List_EnumFrom ( );
extern int List_Enum ( );
extern int List_EnumBackFrom ( );
extern int List_EnumBack ( );
extern int List_Card ( );
extern int List_IsUnlink ( );
