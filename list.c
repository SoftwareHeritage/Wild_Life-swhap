...
static int List_SwapLinks (header, atom)
RefListHeader header;
Ref atom;
{
    Ref	save;
...
int List_EnumFrom (header, atom, proc, closure)
RefListHeader	header;
Ref atom;
...
int List_Enum (header, proc, closure)
RefListHeader	header;
RefListEnumProc	proc;
Ref closure;
/*-----------------------------------------------------------------------------
...
int List_EnumBackFrom (header, atom, proc, closure)
RefListHeader	header;
Ref		atom;
RefListEnumProc	proc;
Ref		closure;
...
int List_EnumBack (header, proc, closure)
RefListHeader	header;
RefListEnumProc	proc;
Ref			closure;
{
...
/*ARGSUSED*/
static int List_CountAtom (p, nbR)
Ref p; 
Ref nbR;
{
    int *nb = (int *)nbR;
