...
typedef struct _GraphicClosure
{
    Display *display;
    Drawable drawable;
    GC gc;
...
typedef struct _PostScriptClosure
{
    int display;
    Drawable window;
    int f;
...
static int x_free_elt (elt, closure)
...
static int x_postscript_elt (elt, psc)
...
int x_postscript_window (display, window, displaylist, filename)
